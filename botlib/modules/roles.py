...
module_cmdList = {
    ...
    'ROLE_GRANT': ['Have Lexi grant a role from the ' + globalVars.cmdStrt + 'roles_list. Only admins can use serverMember arg. Leave blank for self.', globalVars.cmdStrt + 'role_grant|roleName or (for admins) ' + globalVars.cmdStrt + 'role_grant|roleName|serverMember', 1, 1],
    'ROLE_REVOKE': ['Have Lexi revoke a role from a ' + globalVars.cmdStrt + 'roles_ist. Only admins can use serverMember arg. Leave blank for self.', globalVars.cmdStrt + 'role_revoke|roleName or (for admins) ' + globalVars.cmdStrt + 'role_revoke|roleName|serverMember', 1, 1],
}
